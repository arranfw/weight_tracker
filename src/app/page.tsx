        ...
        <main className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="bg-card p-6 rounded-lg shadow-md">
              ...
              <p>See your progress with beautiful charts and analytics.</p>
            </div>

            <div className="bg-card p-6 rounded-lg shadow-md">
              <div className="text-indigo-500 text-4xl mb-4">🔒</div>
              <h3 className="text-xl font-bold mb-2">Private & Secure</h3>
              <p>Your data is always private and securely stored.</p>
            </div>

            <div className="bg-card p-6 rounded-lg shadow-md">
              <div className="text-indigo-500 text-4xl mb-4">📱</div>
              <h3 className="text-xl font-bold mb-2">Access Anywhere</h3>
              <p>Track your progress from any device, anytime.</p>
            </div>
          </div>
